...
* performer.actor only Reference(PractitionerTelemonitoraggio or PractitionerRoleTelemonitoraggio or OrganizationTelemedicina or Patient or deviceTelemonitoraggioTesserino)
